...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
    ...
    let deprecatedTestUtils = await import("./test-utils-4F4BSEXV.js");
...
var beforeAll = async () => {
  try {
    let { configure } = await import("./dist-KOW63TWJ.js"), act = await getAct();
...
//# sourceMappingURL=chunk-OLJOZ7UV.js.map
